...
def convert_inkml_to_png(input_folder, output_folder):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".inkml"):
            ...
            output_file_path = os.path.join(output_folder, f"{output_file_name}.png")
...
input_folder = r'C:\Users\J. Lucas\.vscode-cli\Desktop\Natalie\CROHME_full_v2\CROHME2013_data\TestINKML'

# Pasta de saída para os arquivos PNG
output_folder = r'C:\Users\J. Lucas\.vscode-cli\Desktop\Natalie\CROHME_aux'

# Chame a função para converter os arquivos
convert_inkml_to_png(input_folder, output_folder)
